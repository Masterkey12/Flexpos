...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $all_permissions = [
            ...
            ['label'=>'Invoice Receivings', 'name'=>'receivings.show-invoice'],
            ...
            ['label'=>'Refund Sales', 'name'=>'sale.refund'],
            ['label'=>'Invoice Sales', 'name'=>'sale.show-invoice'],
            ...
            ['label'=>'List Planning', 'name'=>'planning.index'],
            ['label'=>'Create Planning', 'name'=>'planning.create'],
            ['label'=>'Store Planning', 'name'=>'planning.store'],
            ['label'=>'View Planning', 'name'=>'planning.show'],
            ['label'=>'Delete Planning', 'name'=>'planning.destroy'],
            ['label'=>'Update Planning', 'name'=>'planning.update'],
            ['label'=>'Edit Planning', 'name'=>'planning.edit'],
            ...
            ['label'=>'Income Reports', 'name'=>'report.sale'],
            ['label'=>'Expense Reports', 'name'=>'report.receiving'],
            ['label'=>'Stock Reports', 'name'=>'report.stock'],
