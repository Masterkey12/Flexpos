...
@section('content')
  <div class="content-wrapper">
    ...
    <section class="content-header m-3">
      <h1>{{__('Fournisseurs')}} 
        <a class="btn btn-small btn-default pull-right ml-2" href="{{route('suppliers.export')}}" ><i class="fa fa-download"></i>&nbsp; {{__('exporter')}}</a>
  <a class="btn btn-small btn-default pull-right ml-2" href="#supplierImportModal" data-toggle="modal"><i class="fa fa-upload"></i>&nbsp; {{__('importer')}}</a>
        <a class="btn btn-small btn-success pull-right" href="#addSupplierModal" data-toggle='modal'><i class="fa fa-plus"></i>&nbsp; {{__('Ajouter')}}</a></h1>
    </section>
    <!-- Main content -->
