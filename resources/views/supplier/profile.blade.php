...
<section class="content-header">
  <h1><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>{{__('Profil du fournisseur')}}</h1>
</section>
...
<section class="content">
  ...
  <div class="row">
      ...
      <div class="box box-success">
        <div class="box-body box-profile">
          ...
          <ul class="list-group list-group-unbordered">
            ...
            <li class="list-group-item">
              <b>Total des créances </b> <a class="pull-right">{{number_format($total_receivings,2)}}</a>
            </li>
          </ul>
          <a class="btn btn-success btn-block" href="#" data-toggle="modal" data-target="#supplierPaymentModal"><b>{{__('Ajouter paiement')}}</b></a>
            ...
            <div class="modal-dialog modal-sm">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">{{__('Ajouter paiement')}}</h4>
                </div>
     ...
     <!-- About Me Box -->
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title">{{__('Historique des paiements')}}</h3>
        </div>
        <!-- /.box-header -->
    ...
    <!-- /.col -->
    <div class="col-md-9">
      <h3 class="mt-0">{{__('Tous les achats')}}</h3>
