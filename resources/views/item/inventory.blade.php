<div class="modal-content" id="inventory">
    <div class="modal-header">
        ...
        <h4 class="modal-title">{{__('Inventaire')}}</h4>
    </div>
    <div class="modal-body" >
        ...
        <!-- /.box -->
        @include('inventory.partials.inventory_table', ['inventory'=>$sal_inv, 'title'=>'Inventaire des ventes'])
        @include('inventory.partials.inventory_table', ['inventory'=>$rec_inv, 'title'=>'Réception des stocks'])
        @include('inventory.partials.inventory_table', ['inventory'=>$other_inv, 'title'=>'Autres inventaires'])
    </div>    
</div>