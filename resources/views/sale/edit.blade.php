...
<div class="content-wrapper" ng-app="flexiblepos">
    ...
    <section class="content-header"><h1>{{__('Vente')}}</h1></section>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-success">
                <div class="box-header"><h3 class="box-title"> {{__('Modifier une vente')}}</h3></div>
            </div>
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="row" ng-controller="SearchItemCtrl">
                        ...
                        <div class="col-md-9">
                        {{ Form::open(array('url' => $formurl, 'class' => 'form-horizontal', 'data-no-ajax')) }}
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="invoice" class="col-sm-3 control-label">{{trans('sale.invoice')}}</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="invoice_no" id="invoice" value="{{$sale->invoice_no}}" readonly/>
                                        </div>
                                    </div>
                                    <div class="form-group">
