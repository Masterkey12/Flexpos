                ...
                <div class="panel panel-default">
                    <nav class="multineed navbar navbar-default menu-export" role="navigation">
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-mail-forward"></i> {{__('Exporter')}} <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <li><a href="#" id="excel" class="excel"><i class="fa fa-file-excel-o"></i> {{__('En Excel')}}</a></li>
                                    <li><a href="#" class="word"><i class="fa fa-file-word-o"></i> {{__('En Word')}}</a></li>
                                    <li><a href="#" class="pdf"><i class="fa fa-file-pdf-o"></i> {{__('En PDF')}}</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
