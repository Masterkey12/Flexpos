    ...
    <section class="content">
      @include('partials.flash')
        <div class="row">
              ...
              <div class="box-body box-profile">
                ...
                <ul class="list-group list-group-unbordered">
                  ...
                  <li class="list-group-item hidden-print">
                    <b>{{__('Ventes totales')}} </b> <a class="pull-right">{{$total_sales}}</a>
                  </li>
                </ul>
                <a class="btn btn-success btn-block hidden-print" href="#" data-toggle="modal" data-target="#customerPaymentModal"><b>{{__('Ajouter un paiement')}}</b></a>
                  ...
                  <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{__('Ajouter un paiement')}}</h4>
                      </div>
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-success" onclick="closeEl('.submodal', '#customerPaymentModal')">{{__('Fermer')}}</button>
                      </div>
                    </div>
                  </div>
           ...
           <!-- About Me Box -->
            <div class="box box-success">
              <div class="box-header with-border">
                <h3 class="box-title">{{__('Historique des derniers paiements')}}</h3>
              </div>
              <!-- /.box-header -->
          ...
          <!-- /.col -->
          <div class="col-md-9">
            <h3 class="mt-0">Historique de Paiement</h3>
