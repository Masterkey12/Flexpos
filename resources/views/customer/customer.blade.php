<div class="" id="customerDetails">
    ...
    <section class="content-header m-3"><h1>{{__('Clients')}}
      <a class="btn btn-small btn-default pull-right ml-2" href="{{route('customers.export')}}" ><i class="fa fa-download"></i>&nbsp; {{__('exporter')}}</a>
  <a class="btn btn-small btn-default pull-right ml-2" href="#customerImportModal" data-toggle="modal"><i class="fa fa-upload"></i>&nbsp; {{__('importer')}}</a>
      <a class="btn btn-small btn-success pull-right" href="#addCustomerModal" data-toggle='modal'>
      <i class="fa fa-plus"></i>&nbsp; {{__('Ajouter')}}</a></h1></section>
    <!-- Main content -->
