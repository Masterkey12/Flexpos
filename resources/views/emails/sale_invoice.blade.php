...
<table border="0" cellpadding="10" cellspacing="0" width="100%">
    <tr>
        <td valign="top" width="350">
            <em><strong>
                    <p>Veuillez trouver en Piece Jointe votre Facture</p>
                </strong></em>
        </td>
    </tr>
</table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="600" id="templateContainer">
                        <tr>
                            <td colspan="2" align="center" valign="top">
                                ...
                                <table border="0" cellpadding="10" cellspacing="20" width="600" id="templateHeader">
                                    <tr>
                                        <td class="headerContent">
                                            <!-- // Begin Module: Standard Header Image \\ -->
                                            @if(!empty(setting('logo_path')))
                                            <img src="{{asset(setting('logo_path'))}}" width="150" alt="logo">
                                            @else
                                            <img src="{{asset('images/fpos.png')}}" width="150" alt="logo">
                                            @endif
                        ...
                        <tr>
                            <td colspan="2" align="center" valign="top">
                                ...
                                <table border="1" cellpadding="10" cellspacing="0" width="600" id="templateFooter">
                                    <tr>
                                        <th>{{trans('sale.item')}}</th>
                                        <th>{{trans('sale.price')}}</th>
                                        <th align="center">{{trans('sale.qty')}}</th>
                                    ...
                                    @endforeach
                                    <tr>
                                        <td colspan="2">{{trans('sale.payment_type')}}: {{$sales->payment_type}}</td>
                                        <td align="right">{{__('Subtotal')}}:</td>
                                        <td align="right"><span class="text-left">{{currencySymbol()}}</span><span
                                                class="pull-right">
                                                {{ $sales->discount + $sales->grand_total - $sales->tax }}</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"></td>
                                        <td align="right">{{__('Discount')}}:</td>
                                        <td align="right"><span class="text-left"> {{currencySymbol()}}</span><span
                                                class="pull-right"> {{ $sales->discount }}</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"></td>
                                        <td align="right">{{__('Payment')}}: </td>
                                        <td align="right"><span class="text-left"> {{currencySymbol()}}</span><span
                                                class="pull-right"> {{ $sales->payment }}</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"></td>
                                        <td align="right">{{__('Tax')}}: </td>
                                        <td align="right"><span class="text-left">{{currencySymbol()}}</span><span
                                                class="pull-right"> {{ $sales->tax }}</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"></td>
                                        <td align="right">{{__('Dues')}}: </td>
                                        <td align="right"><span class="text-left">{{currencySymbol()}}</span><span
                                                class="pull-right"> {{ $sales->dues }}</span></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
